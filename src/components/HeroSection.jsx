    ...
    <div id="#" className="flex flex-col items-center mt-6 lg:mt-20">
      <h1 className="text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide">
        ...
        <span className="bg-gradient-to-r from-green-500 to-green-800 text-transparent bg-clip-text">
          {" "}
          with <br /> Solar Energy
        </span>
      </h1>
      <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
        Harness the Power of the Sun and Light Up Your Life with Our
        Cutting-Edge Solar Solutions. Start Today and Turn Your Space into a
        Sustainable Haven!
      </p>
      <div className="flex justify-center my-10">
        ...
        <a href="#contactus" className="py-3 px-4 mx-3 rounded-md border">
          Contact Us
        </a>
      </div>
